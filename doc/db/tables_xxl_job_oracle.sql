...
-- Create/Recreate indexes
create index IDX_XXL_LOG_REPORT_TRIGGER_DAY on XXL_JOB_LOG_REPORT (trigger_day)
;
-- Create/Recreate primary, unique and foreign key constraints
...
;
create index IDX_XXL_REGISTRY_UPDATE_TIME on XXL_JOB_REGISTRY (UPDATE_TIME)
;
-- Create/Recreate primary, unique and foreign key constraints
...
-- Create trigger
create or replace trigger tg_XXL_JOB_GROUP
--before:
...
create or replace trigger tg_XXL_JOB_INFO
--before:
...
create or replace trigger tg_XXL_JOB_LOGGLUE
--before:
...
create or replace trigger tg_XXL_JOB_LOG
--before:
...
create or replace trigger tg_XXL_JOB_LOG_REPORT
--before:
...
create or replace trigger tg_XXL_JOB_REGISTRY
--before:
...
create or replace trigger tg_XXL_JOB_USER
--before:
