...
public class AdminBizClient implements AdminBiz {
    ...
    public ReturnT<String> registryRemove(RegistryParam registryParam) {
        return XxlJobRemotingUtil.postBody(
                addressUrl + "api/registryRemove", accessToken, timeout, registryParam, String.class);
    }

    @Override
    public ReturnT<String> initJobInfo(JobExecutorInitParam jobExecutorInitParam) {
        return XxlJobRemotingUtil.postBody(
                addressUrl + "api/initJobInfo", accessToken, timeout, jobExecutorInitParam, String.class);
    }
}
