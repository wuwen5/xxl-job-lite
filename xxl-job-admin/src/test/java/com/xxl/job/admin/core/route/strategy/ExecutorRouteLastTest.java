...
/**
 * Unit tests for ExecutorRouteLast
 */
public class ExecutorRouteLastTest {

    @Test
    public void shouldRouteToLastAddress() {
        ...
        assertEquals("192.168.1.3:9999", result.getContent());
    }

    @Test
    public void shouldAlwaysReturnLastAddress() {
        ExecutorRouteLast router = new ExecutorRouteLast();
        List<String> addressList = Arrays.asList("192.168.1.1:9999", "192.168.1.2:9999", "192.168.1.3:9999");
        ...
        // Route multiple times - should always return last address
        for (int i = 0; i < 10; i++) {
            ReturnT<String> result = router.route(triggerParam, addressList);
            assertEquals("192.168.1.3:9999", result.getContent());
        }
