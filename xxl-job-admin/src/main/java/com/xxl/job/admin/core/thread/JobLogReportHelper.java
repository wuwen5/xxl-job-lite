    ...
    private static void refreshLogReport() {
        for (int i = 0; i < REPORT_DAYS; i++) {
            ...
            if (triggerCountMap != null && !triggerCountMap.isEmpty()) {
                ...
                int triggerDayCount = map.containsKey("triggerDayCount")
                        ? Integer.parseInt(String.valueOf(map.get("triggerDayCount")))
                        : 0;
                int triggerDayCountRunning = map.containsKey("triggerDayCountRunning")
                        ? Integer.parseInt(String.valueOf(map.get("triggerDayCountRunning")))
                        : 0;
                int triggerDayCountSuc = map.containsKey("triggerDayCountSuc")
                        ? Integer.parseInt(String.valueOf(map.get("triggerDayCountSuc")))
                        : 0;
